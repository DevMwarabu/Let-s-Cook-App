...
public class Areas extends AppCompatActivity {
    private String url = "https://www.themealdb.com/api/json/v2/9973533/list.php?a=list";
    private RecyclerView mRecyclerView;
    private List<AreaList> mealLists;
    private AreaAdapter mealsAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mealsAdapter = new AreaAdapter(mealLists);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            for (int i = 0; i < heroArray.length(); i++) {
                                ...
                                AreaList areaList = new AreaList(strArea);

                                mealLists.add(areaList);
                            ...
                            e.printStackTrace();
                            Toast.makeText(Areas.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                            ...
                            Toast.makeText(Areas.this, "Check your connection", Toast.LENGTH_LONG).show();
