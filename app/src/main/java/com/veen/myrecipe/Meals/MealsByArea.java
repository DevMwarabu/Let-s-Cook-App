...
public class MealsByArea extends AppCompatActivity {
    private String strArea,url = "https://www.themealdb.com/api/json/v2/9973533/filter.php?a=";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        strArea = getIntent().getExtras().getString("strArea");
    ...
    private void loadingMeals(String url){
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url+strArea,
                new com.android.volley.Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            e.printStackTrace();
                            Toast.makeText(MealsByArea.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                            ...
                            Toast.makeText(MealsByArea.this, "Check your connection", Toast.LENGTH_LONG).show();
